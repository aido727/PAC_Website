...
<script language="JavaScript" type="text/javascript">
	document.title = document.title + " - Create New News Post";
</script>
...
<span class="page-title">CREATE NEW NEWS POST</span>
<form class="comicborder" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?go=newpost_news" method="POST" autocomplete="off" >
	<br/>
		<?php 
			$type_value = "News"; //hard code post type
